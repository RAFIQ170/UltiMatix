package genricUtilityImplimention;
...
import genricLibraries.PropertiesFileUtility;
...
//		salutation.selectByValue("Mrs.");
		...
		String leadName = map.get("Last Name")+javaUtil.genrateRandomNumber(100);
		...
		if(duplicatingPage.contains(leadName))
			...
			System.out.println("Fail");
		String duplicateLeadName = map.get("New Last Name")+javaUtil.genrateRandomNumber(100);
