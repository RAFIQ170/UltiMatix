...
/**
 * This class contains all reusable methodes of webdriver
 * @author mrafi
 *
 */
 ...
 */
		...
		public void l(long time, WebElement element) {
...
/**
 * This method is used to double click on an elemnt		
 * @param element
 */
...
/**		
 * This method is used to select an element from drop down bases on value
 * @param element
 * @param value
 */
...
/**
 * This method is used to handle child child browser pop up		
 * @param element 
 * @param element 
 * @param element 
 */
...
/**
 * This method is used to switch to frame based on an element
 * @param element
 */
 ...
 * @return
 */
 public ChromeOptions disabaleNotification() {
 ...
 */
 public String getScreenshot(JavaUtility javaUtil, String classname) {
	 ...
	 File desr=new File("./Screenshot/"+classname+"_"+currentTime+".png");
	 
	 try {
		FileUtils.copyFile(src, desr);
	} catch (IOException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
	 return desr.getAbsolutePath();
 }
/**
 ...
 */
  ...
  */
 public void closeCureentWindow() {
	 driver.close();
 }
 /**
